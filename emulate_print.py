...
def create_request(layer_count_from_start, project_name, cur_layer_number):
    ...
    svg_path = f"{project_name}/../svg/{add_zeros}{cur_layer_number}.svg"  # TODO: create normal svg filename
